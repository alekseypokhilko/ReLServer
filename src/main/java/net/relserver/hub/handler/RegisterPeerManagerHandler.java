...
public class RegisterPeerManagerHandler implements RequestHandler {
    private final ClientRegistry clientRegistry;
    private final PeerRegistry peerRegistry;

    public RegisterPeerManagerHandler(ClientRegistry clientRegistry, PeerRegistry peerRegistry) {
